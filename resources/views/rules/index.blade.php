			...
			<div class="card">
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						$sql2 = "SELECT * FROM datatraining_ppa ORDER BY RAND() LIMIT 25";
						// where id IN ('84','102','107','69','88','106','115','80','66','129','6','105','48','119','63','76','104','70','72','41','117','29','73','25','77');
						...
						<table class="table table-bordered">
							...
							<?php while ($data3 = mysqli_fetch_array($query2)) : ?>
								<?php 
								$data_testing = [$data3['jumlah'],$data3['penghasilan_ortu'],$data3['jumlah_sks'],$data3['ipk']]; 
								$kep = $c45->predictDataTesting($data_testing); 
								if ($kep == "LAYAK" && $data3['keterangan'] == "layak") {
									$tp = $tp + 1;
								}elseif ($kep == "TIDAK LAYAK" && $data3['keterangan'] == "tidak layak") {
									$tn+=1;
								}elseif ($kep == "LAYAK" && $data3['keterangan'] == "tidak layak") {
									$fp+=1;
								}elseif ($kep == "TIDAK LAYAK" && $data3['keterangan'] == "layak") {
									$fn+=1;
								}
								?>
								<tr>
